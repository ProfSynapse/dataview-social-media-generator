...
// Function to call OpenAI API and generate content based on the platform
...
2. Provide a brief overview of what viewers will learn, using 3-4 bullet points.0
...
${content}`;
    ...
    try {
        console.log(`Sending request to OpenAI for ${platform}`);
