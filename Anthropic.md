...
// Function to call Anthropic API and generate content based on the platform
...
${content}`;
    ...
    try {
        console.log(`Sending request to Anthropic for ${platform}`);
        const response = await fetch("https://api.anthropic.com/v1/messages", {
            ...
            body: JSON.stringify({
                model: "claude-2", // Adjust model if necessary
                messages: [
